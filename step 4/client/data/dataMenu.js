...
let DataMenu = {};
 ...
 /**
     * Fetches data from the server based on the specified direction.
     *
     ...
     * Elle prend en paramètre un jour de la semaine et renvoie les données contenues
     * dans la réponse du serveur (data).
     */
DataMenu.request = async function(day){
    // fetch permet d'envoyer une requête HTTP à l'URL spécifiée. 
    // L'URL est construite en concaténant HOST_URL à "/server/script.php?direction=" et la valeur de la variable dir. 
    // L'URL finale dépend de la valeur de HOST_URL et de dir.
    let answer = await fetch(HOST_URL + "/server/script.php?jeNeSuisPasLeBonParametre=" + day);
